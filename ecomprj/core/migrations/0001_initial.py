# Generated by Django 5.0.4 on 2024-07-05 06:50
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(default='Shopify', max_length=100)),
                ('image', models.ImageField(default='User.jpg', upload_to='categoryAdmin/')),
            ],
        ),
        migrations.CreateModel(
            name='Seller',
            fields=[
                ...
                ('title', models.CharField(default='Seller Name', max_length=100)),
                ('image', models.ImageField(default='Seller.jpg', upload_to=core.models.user_directory_path)),
                ('description', models.TextField(blank=True, default='This is the Seller', null=True)),
                ('address', models.CharField(default='Street Name.', max_length=100)),
                ('contact', models.CharField(default='+977 number', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('price', models.DecimalField(decimal_places=2, default='1200', max_digits=99999999999999)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.DecimalField(decimal_places=2, default='1200', max_digits=99999999999999)),
                ('total', models.DecimalField(decimal_places=2, default='1200', max_digits=99999999999999)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('old_price', models.DecimalField(decimal_places=2, default='1000', max_digits=10)),
                ...
                ('sku', shortuuid.django_fields.ShortUUIDField(alphabet=None, length=22, max_length=10, prefix='', unique=True)),
